...
![IsolateMachine_Run_1](Images/IsolateMachine_Run_1.png)

From the "**Run playbook on incident**" view, type "**AS-MDE-Isolate-Machine**" into the search bar, then click run.

![IsolateMachine_Run_2](Images/IsolateMachine_Run_2.png)
